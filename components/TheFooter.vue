<template>
  <footer class="bg-black text-white pt-16 pb-20 border-t border-white/5 font-sans relative z-10">
    <div class="container mx-auto px-6">
      <div class="grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div class="md:col-span-5 md:col-start-8 flex flex-col items-start md:items-end text-left md:text-right">
              ...
              <a :href="isMobile && social.mobileUrl ? social.mobileUrl : social.url" target="_blank"
                ...
                <img :src="social.icon" :alt="social.name"
                  ...
                  :class="[
                    social.padding || 'p-1',
                    social.offset,
                    // 默认状态：灰色+透明度；Hover状态：移除滤镜变回原色
                    social.filterClass || 'filter brightness-0 invert opacity-40',
                ...
                <div class="bg-white/60 backdrop-blur-2xl p-3 rounded-xl shadow-2xl ring-1 ring-white/40 relative">
                  <div class="w-32 h-32 flex items-center justify-center overflow-hidden rounded-lg">
                    <div class="w-full h-full bg-white/60 flex items-center justify-center">
                      <NuxtImg :src="social.qr" :alt="social.name" class="w-full h-full object-cover" width="128"
                        height="128" loading="lazy" format="webp" />
                    </div>
                  </div>
          ...
          <div class="mt-auto text-xs text-gray-600 font-sans">
            <p>沪ICP备2025109966号-1</p>
            <p class="mt-1">© 2025 Raydiene. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
