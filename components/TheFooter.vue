  ...
  <footer class="bg-black text-white border-t border-white/10 font-sans relative z-10 w-full">
    <div class="md:hidden pt-10 pb-20 px-6">
      <div class="flex flex-col items-center w-fit mb-10">
        ...
        <p class="-mt-2 text-xl tracking-[0.18em] pl-[0.18em] text-white opacity-90 leading-none whitespace-nowrap">
          智享充电，悦享安全
        </p>

        <p
          class="mt-5 text-[10px] tracking-[0.18em] pl-[0.18em] text-white font-['Michroma'] uppercase opacity-90 leading-none whitespace-nowrap">
      ...
      <div class="grid grid-cols-2 gap-x-4 gap-y-10 mb-12 border-t border-white/5 pt-8">
        ...
        <div>
          ...
          <ul class="space-y-3 text-xs text-gray-400">
            <li>
              <NuxtLink to="/service/install">安装服务</NuxtLink>
            </li>
            <li>
      ...
      <div class="mb-10">
        <h4 class="text-white font-bold mb-6 text-sm tracking-wide">
          联系我们
        </h4>
      ...
      <div class="mb-10">
        ...
        <div class="flex flex-wrap gap-6">
          <a v-for="(social, index) in socialLinks" :key="index" :href="social.mobileUrl || social.url" target="_blank"
        ...
        <div class="flex flex-row justify-between items-start mb-4">
          <div class="w-auto xl:w-80 flex flex-col flex-shrink-0 items-center h-36 justify-between">
            <div class="flex-grow flex items-center justify-center mt-2">
              <img src="/images/logo-cn2.svg" alt="雷迪恩 RAYDIENE 品牌Logo" class="w-80 h-auto opacity-90 object-contain" />
            </div>

            <div class="flex flex-col items-center pb-1">
              <p
                class="text-[24px] tracking-[0.18em] pl-[0.18em] text-white opacity-90 leading-none whitespace-nowrap mb-4">
                智享充电，悦享安全
              </p>

              <p
                class="text-[10px] tracking-[0.18em] pl-[0.18em] text-white font-['Michroma'] uppercase opacity-90 leading-none whitespace-nowrap">
                CHARGING FOR BETTER WORLD
              </p>
            </div>
          </div>
          ...
          <div class="flex flex-row gap-x-10 lg:gap-x-16 mx-auto pt-1">
            <div class="flex flex-col">
              <h4 class="text-white font-bold mb-5 text-sm tracking-wide">
                产品介绍
              </h4>
              <ul class="space-y-3 text-xs text-gray-400">
                <li>
                  <NuxtLink to="/products/xingyao" class="hover:text-white transition-colors block">星耀系列</NuxtLink>
                </li>
                <li>
                  <NuxtLink to="/products/xingchen" class="hover:text-white transition-colors block">星辰系列</NuxtLink>
                </li>
                <li>
                  <NuxtLink to="/products/panshi" class="hover:text-white transition-colors block">磐石系列</NuxtLink>
                </li>
                <li>
                  <NuxtLink to="/products/jianshi" class="hover:text-white transition-colors block">坚石系列</NuxtLink>
                </li>
              </ul>
            </div>
            <div class="flex flex-col">
              ...
              <ul class="space-y-3 text-xs text-gray-400">
                <li>
                  <NuxtLink to="/service/install" class="hover:text-white transition-colors block">安装服务</NuxtLink>
                </li>
                <li>
            ...
            <div class="flex flex-col">
              ...
              <ul class="space-y-3 text-xs text-gray-400">
                <li>
                  <NuxtLink to="/about/intro" class="hover:text-white transition-colors block">企业简介</NuxtLink>
                </li>
                <li>
                  <NuxtLink to="/about/culture" class="hover:text-white transition-colors block">企业文化</NuxtLink>
                </li>
          ...
          <div class="w-auto xl:w-72 flex flex-col flex-shrink-0 pt-1 items-start text-left">
            <div class="flex flex-col items-start mb-8">
              <h4 class="text-white font-bold mb-5 text-sm tracking-wide leading-none">
                联系我们
              </h4>
              <div class="space-y-3 flex flex-col items-start">
                <div class="flex items-center gap-x-3 text-gray-400 text-xs hover:text-white transition-colors group">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-4 h-4 group-hover:stroke-white transition-colors">
                    <path stroke-linecap="round" stroke-linejoin="round"
                      d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                  </svg>
            ...
            <div class="flex flex-col items-start">
              ...
              <div class="flex flex-row gap-x-5 items-center">
                <div v-for="(social, index) in socialLinks" :key="index" class="relative group cursor-pointer">
                  ...
                  <div
                    class="absolute bottom-full mb-3 z-50 opacity-0 translate-y-4 invisible group-hover:transition-transform group-hover:duration-500 group-hover:ease-out group-hover:opacity-100 group-hover:translate-y-0 group-hover:visible left-1/2 -translate-x-1/2 pointer-events-none">
                    <div class="bg-white p-2 rounded-lg shadow-2xl ring-1 ring-white/20 relative">
                      <div class="w-24 h-24 flex items-center justify-center overflow-hidden rounded">
                        <NuxtImg :src="social.qr" :alt="social.name" class="w-full h-full object-cover" width="96"
                          height="96" loading="lazy" format="webp" />
                      </div>
                      <p class="text-black text-center text-[10px] mt-1 font-bold whitespace-nowrap">
                        {{ social.name }}
                      </p>
