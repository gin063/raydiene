      ...
      <div class="absolute inset-0 z-10 w-full h-full">
        ...
        <div
          ...
          <div
            ...
            <svg v-if="!isHeroPlaying" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
              class="w-6 h-6 ml-1">
            ...
            <div class="absolute inset-x-0 top-0 pt-12 md:pt-16 flex flex-col items-center text-center z-20 px-6">
              ...
              <div
                ...
                <NuxtLink :to="product.link"
                  class="px-6 py-2 rounded-full border border-white/10 bg-blue-600/80 backdrop-blur-md text-sm font-bold text-white hover:bg-white hover:text-black duration-500 transition-colors">
                  了解更多
                </NuxtLink>
              </div>
            </div>
    ...
    <section class="w-full bg-black text-white pb-16">
      <div class="container mx-auto px-6 md:px-24 flex flex-col gap-10 items-center max-w-[1600px]">
        <div
          ...
          <div
            class="w-full md:w-[40%] h-full bg-black p-8 md:p-12 flex flex-col justify-center items-start z-10 relative">
            ...
            <NuxtLink to="service/install"
              class="px-8 py-3 bg-white text-black font-bold rounded-full duration-500 transition-all backdrop-blur-md border border-transparent hover:bg-white/10 hover:text-white hover:border-white/50 flex items-center gap-2 text-lg">
              了解详情
