<template>
  <div class="relative min-h-screen w-full bg-[#050505] text-white selection:bg-cyan-500 selection:text-white overflow-x-hidden font-sans">

    <div class="relative w-full h-screen">
      <div class="absolute inset-0 z-0 overflow-hidden">
        <NuxtImg 
          src="/images/products/xingyao/scene-bg.jpg" 
          alt="星耀系列场景" 
      ...
      <div class="relative z-10 container mx-auto px-6 h-full flex flex-col justify-end items-center text-center pb-32 md:pb-48">
        ...
        <p class="text-xl md:text-2xl text-gray-200 font-light tracking-wide mb-12 animate-fade-in-up" style="animation-delay: 0.2s">
      ...
      <div class="container mx-auto px-6">
        <div class="grid grid-cols-2 md:grid-cols-5 gap-8 text-center">
          <div class="flex flex-col items-center gap-3 group">
            <div class="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform">
            ...
            <h3 class="text-sm font-bold text-gray-300">适配99%车型</h3>
          </div>
          <div class="flex flex-col items-center gap-3 group">
            <div class="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform">
            ...
            <h3 class="text-sm font-bold text-gray-300">专业上门安装</h3>
          </div>
          <div class="flex flex-col items-center gap-3 group">
            <div class="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform">
            ...
            <h3 class="text-sm font-bold text-gray-300">7*15h 响应</h3>
          </div>
          <div class="flex flex-col items-center gap-3 group">
            <div class="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform">
            ...
            <h3 class="text-sm font-bold text-gray-300">4年质保只换不修</h3>
          </div>
          <div class="flex flex-col items-center gap-3 group">
            <div class="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform">
            ...
            <h3 class="text-sm font-bold text-gray-300">终身免费流量 & OTA</h3>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="flex flex-col lg:flex-row items-center gap-16">
          <div class="w-full lg:w-1/2 animate-on-scroll">
            <div class="relative aspect-[16/9] rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <NuxtImg 
                src="/images/products/xingyao/detail.jpg" 
                alt="星耀系列旗舰质感" 
          ...
          <div class="w-full lg:w-1/2 animate-on-scroll">
            ...
            <div class="grid grid-cols-2 gap-6">
              <div class="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-cyan-500/30 transition-colors">
                ...
                <h4 class="text-lg font-bold mb-1">7寸智能触控</h4>
                <p class="text-xs text-gray-400">大屏交互 如手机般流畅</p>
              </div>
              <div class="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-cyan-500/30 transition-colors">
                <div class="text-cyan-400 mb-2">
                  <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.243-8.25-3.285z"></path></svg>
                </div>
              ...
              <div class="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-cyan-500/30 transition-colors">
                <div class="text-cyan-400 mb-2">
                  <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.5 13.5L12 21m0 0l-7.5-7.5M12 21V3"></path></svg>
                </div>
                <h4 class="text-lg font-bold mb-1">特斯拉一键开盖</h4>
                <p class="text-xs text-gray-400">智能感应 便捷体验</p>
              </div>
              <div class="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-cyan-500/30 transition-colors">
                <div class="text-cyan-400 mb-2">
                ...
                <h4 class="text-lg font-bold mb-1">智能语音助手</h4>
                <p class="text-xs text-gray-400">语音播报 & 充满自停</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="py-24 bg-[#050505] relative overflow-hidden">
      <div class="absolute right-0 top-1/4 w-[50vw] h-[50vw] bg-cyan-900/10 rounded-full blur-[120px] pointer-events-none"></div>
      <div class="container mx-auto px-6">
        <div class="flex flex-col lg:flex-row-reverse items-center gap-16">
          <div class="w-full lg:w-1/2 animate-on-scroll">
            <div class="relative mx-auto max-w-2xl">
              <NuxtImg 
                src="/images/products/xingyao/app-scene.png" 
                alt="星耀智能交互" 
          ...
          <div class="w-full lg:w-1/2 animate-on-scroll">
            <h2 class="text-3xl md:text-4xl font-bold mb-6 font-hero">智控 · 个性定义</h2>
            <p class="text-gray-400 mb-10 text-lg">
              不仅仅是充电。自定义屏保、个性化氛围灯，让充电桩成为您车库中的艺术品。
            </p>
            <ul class="space-y-6">
              <li class="flex items-start gap-4">
                <div class="w-10 h-10 rounded-lg bg-cyan-500/10 flex items-center justify-center text-cyan-400 shrink-0">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4.098 19.902a3.75 3.75 0 005.304 0l6.401-6.402M6.75 21A3.75 3.75 0 013 17.25V4.125C3 3.504 3.504 3 4.125 3h5.25c.621 0 1.125.504 1.125 1.125v4.072M6.75 21a3.75 3.75 0 003.75-3.75V8.197M6.75 21h13.125c.621 0 1.125-.504 1.125-1.125v-5.25c0-.621-.504-1.125-1.125-1.125h-4.072M10.5 8.197l2.88-2.88c.438-.439 1.15-.439 1.59 0l3.712 3.713c.44.44.44 1.152 0 1.59l-2.879 2.88M6.75 17.25h.008v.008H6.75v-.008z"></path></svg>
                </div>
                <div>
                  <h4 class="text-xl font-bold text-white">个性化定制</h4>
                  <p class="text-gray-500 text-sm mt-1">自定义屏保画面，可调节流光氛围灯。</p>
                </div>
              </li>
              <li class="flex items-start gap-4">
                <div class="w-10 h-10 rounded-lg bg-cyan-500/10 flex items-center justify-center text-cyan-400 shrink-0">
                ...
                <div>
                  <h4 class="text-xl font-bold text-white">智能语音播报</h4>
                  <p class="text-gray-500 text-sm mt-1">充电状态语音实时提醒，人机交互更友好。</p>
                </div>
              </li>
              <li class="flex items-start gap-4">
                <div class="w-10 h-10 rounded-lg bg-cyan-500/10 flex items-center justify-center text-cyan-400 shrink-0">
                  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.5 6a7.5 7.5 0 107.5 7.5h-7.5V6z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13.5 10.5H21A7.5 7.5 0 0013.5 3v7.5z"></path></svg>
                </div>
                <div>
                  <h4 class="text-xl font-bold text-white">全数据监控</h4>
                  <p class="text-gray-500 text-sm mt-1">APP远程管理，实时屏显，一切尽在掌握。</p>
                </div>
              </li>
            </ul>
          </div>
      ...
      <div class="container mx-auto px-6">
              ...
              <table class="w-full text-left text-sm md:text-base">
                <tbody class="divide-y divide-white/10">
                  <tr class="bg-white/5">
                    ...
                    <td class="p-4 text-white">A1507-GB01-101</td>
                  </tr>
                  <tr>
                    <td class="p-4 font-bold text-gray-300">产品名称</td>
                    <td class="p-4 text-white">星耀系列交流充电桩</td>
                  </tr>
                  <tr class="bg-white/5">
                    <td class="p-4 font-bold text-gray-300">最大功率</td>
                    <td class="p-4">
                      <span class="text-cyan-400 font-bold">7 kW</span> 
                      <span class="mx-2 text-gray-600">/</span> 
                      <span class="text-cyan-400 font-bold">21 kW</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="p-4 font-bold text-gray-300">输入输出电压</td>
                    <td class="p-4 text-white">
                      AC 220V ± 20% <span class="mx-2 text-gray-600">/</span> AC 380V ± 20%
                    </td>
                  </tr>
                  <tr class="bg-white/5">
                    <td class="p-4 font-bold text-gray-300">设备重量</td>
                    <td class="p-4 text-white">
                      5.6kg <span class="mx-2 text-gray-600">/</span> 7kg
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr class="bg-white/5">
                    ...
                    <td class="p-4 text-white">365 * 235 * 120 (mm)</td>
                  </tr>
                  <tr>
                    <td class="p-4 font-bold text-gray-300">外壳材质</td>
                    <td class="p-4 text-white">钢化玻璃 + 合金 + PC</td>
                  </tr>
                  <tr class="bg-white/5">
                  ...
                  <tr class="bg-white/5">
                    ...
                    <td class="p-4 text-white">7.5 米</td>
                  </tr>
                  <tr>
                    <td class="p-4 font-bold text-gray-300">安装方式</td>
                    <td class="p-4 text-white">壁挂式 / 立柱式</td>
                  </tr>
                  <tr class="bg-white/5">
                  ...
                  <tr>
                    ...
                    <td class="p-4 text-white text-sm leading-relaxed text-gray-400">
                      漏电保护、防反接保护、接地保护、过温保护、雷电保护、静电保护、防盗充保护、急停保护、浪涌保护、过充保护等21重主动安全防护。
                    </td>
                  </tr>
                </tbody>
              </table>
        ...
        <div class="w-full relative aspect-[21/9] rounded-xl overflow-hidden border border-white/10 shadow-2xl group">
          ...
          <div class="absolute bottom-6 left-6 bg-black/60 backdrop-blur px-4 py-2 rounded-lg">
            <span class="text-sm font-bold text-cyan-400">XINGYAO</span>
            <span class="text-xs text-white ml-2">触控大屏 · 旗舰之选</span>
          </div>
        </div>
