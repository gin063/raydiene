    ...
    <div class="relative w-full h-screen">
      ...
      <div
        ...
        <div class="flex animate-fade-in-up" style="animation-delay: 0.4s">
          <a href="https://item.jd.com/10157161125734.html" target="_blank" rel="noopener noreferrer"
            ...
            <div class="grid grid-cols-2 gap-6">
              ...
              <div class="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-brand/30 transition-colors">
                <div class="text-brand mb-2">
                  <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                      d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115 18.257V17.25m-9-12V15a2.25 2.25 0 002.25 2.25h9.75A2.25 2.25 0 0020.25 15V5.25A2.25 2.25 0 0018 3H6a2.25 2.25 0 00-2.25 2.25z">
                    </path>
                  </svg>
                </div>
      ...
      <div class="container mx-auto px-6">
        ...
        <div class="w-full relative aspect-[21/9] rounded-xl overflow-hidden border border-white/10 shadow-2xl group">
          ...
          <div class="absolute bottom-6 left-6 bg-black/60 backdrop-blur px-4 py-2 rounded-lg">
            <span class="text-sm font-bold text-brand">星辰</span>
            <span class="text-xs text-white ml-2">智能科技 · 美学之光</span>
          </div>
        </div>
