<template>
  <div class="relative min-h-screen w-full bg-[#050505] text-white selection:bg-blue-500 selection:text-white overflow-x-hidden">
      ...
      <div class="container mx-auto px-6">
        <div class="grid grid-cols-2 md:grid-cols-5 gap-8 text-center">
          <div class="flex flex-col items-center gap-3 group">
            <div class="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-blue-400 group-hover:scale-110 transition-transform">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div class="w-full lg:w-1/2 animate-on-scroll">
            ...
            <div class="grid grid-cols-2 gap-6">
              <div class="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-blue-500/30 transition-colors">
                ...
                <h4 class="text-lg font-bold mb-1">IP65 防护</h4>
                <p class="text-xs text-gray-400">IP6X防尘 / IPX5防水</p>
              </div>
              ...
              <div class="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-blue-500/30 transition-colors">
                ...
                <h4 class="text-lg font-bold mb-1">20重 安全防护</h4>
    ...
    <section class="py-24 bg-[#050505] relative overflow-hidden">
      <div class="absolute right-0 top-1/4 w-[50vw] h-[50vw] bg-blue-900/10 rounded-full blur-[120px] pointer-events-none"></div>
              ...
              <table class="w-full text-left text-sm md:text-base">
                <tbody class="divide-y divide-white/10">
                  ...
                  <tr class="bg-white/5">
                    ...
                    <td class="p-4 text-white font-bold text-blue-400">7 kW</td>
                  </tr>
                  <tr>
