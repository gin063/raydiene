  ...
  <div class="relative min-h-screen w-full bg-[#050505] text-white selection:bg-brand selection:text-white overflow-x-hidden font-sans">
    ...
    <div class="relative w-full h-screen">
      <div class="absolute inset-0 z-0 overflow-hidden">
        <NuxtImg 
          src="/images/products/jianshi/scene-bg.jpg" 
          alt="坚石系列场景" 
        ...
        <div class="flex flex-col lg:flex-row items-center gap-16">
          <div class="w-full lg:w-1/2 animate-on-scroll">
            <div class="relative aspect-[16/9] rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <NuxtImg 
                src="/images/products/jianshi/detail.jpg" 
                alt="坚石产品质感" 
          ...
          <div class="w-full lg:w-1/2 animate-on-scroll">
            <h2 class="text-3xl md:text-4xl font-bold mb-4 font-hero">全天候 · 硬核防护</h2>
            ...
            <div class="grid grid-cols-2 gap-6">
              <div class="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-brand/30 transition-colors">
                ...
                <h4 class="text-lg font-bold mb-1">IP67/IP65 防护</h4>
              ...
              <div class="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-brand/30 transition-colors">
                ...
                <h4 class="text-lg font-bold mb-1">20重安全防护</h4>
                <p class="text-xs text-gray-400">过压/过流/漏电/防雷等</p>
              </div>
              <div class="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-brand/30 transition-colors">
                <div class="text-brand mb-2">
                ...
                <h4 class="text-lg font-bold mb-1">-30℃ ~ 50℃</h4>
                <p class="text-xs text-gray-400">极端温度稳定运行</p>
              </div>
              <div class="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-brand/30 transition-colors">
                <div class="text-brand mb-2">
                ...
                <h4 class="text-lg font-bold mb-1">智能互联</h4>
                <p class="text-xs text-gray-400">蓝牙 / 4G / 充满自停</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="w-full lg:w-1/2 animate-on-scroll">
            ...
            <ul class="space-y-6">
              <li class="flex items-start gap-4">
                ...
                <div>
                  <h4 class="text-xl font-bold text-white">APP 远程管理</h4>
                  <p class="text-gray-500 text-sm mt-1">无论身在何处，一键启动/停止充电，实时查看进度。</p>
                </div>
              </li>
              <li class="flex items-start gap-4">
                <div class="w-10 h-10 rounded-lg bg-brand/10 flex items-center justify-center text-brand shrink-0">
                ...
                <div>
                  <h4 class="text-xl font-bold text-white">预约错峰充电</h4>
              ...
              <li class="flex items-start gap-4">
                ...
                <div>
                  <h4 class="text-xl font-bold text-white">私桩共享</h4>
                  <p class="text-gray-500 text-sm mt-1">闲置时可授权亲友使用，或共享赚取收益。</p>
                </div>
              </li>
            </ul>
          </div>
    ...
    <section class="py-24 bg-[#0a0a0a] border-t border-white/5">
      <div class="container mx-auto px-6">
              ...
              <table class="w-full text-left text-sm md:text-base">
                <tbody class="divide-y divide-white/10">
                  <tr class="bg-white/5">
                    ...
                    <td class="p-4 text-white">A1607-GB01-101</td>
                  </tr>
                  <tr>
                    <td class="p-4 font-bold text-gray-300">产品名称</td>
                    <td class="p-4 text-white">坚石系列交流充电桩（家用版）</td>
                  </tr>
                  <tr class="bg-white/5">
                    <td class="p-4 font-bold text-gray-300">最大功率</td>
                    <td class="p-4 font-bold text-brand">7 kW</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="p-4 text-white">5 米</td>
                  </tr>
                  <tr class="bg-white/5">
        ...
        <div class="w-full relative aspect-[21/9] rounded-xl overflow-hidden border border-white/10 shadow-2xl group">
          <NuxtImg 
            src="/images/products/jianshi/lifestyle.jpg" 
            alt="坚石系列生活场景" 
          ...
          <div class="absolute bottom-6 left-6 bg-black/60 backdrop-blur px-4 py-2 rounded-lg">
            <span class="text-sm font-bold text-brand">LIFESTYLE</span>
            <span class="text-xs text-white ml-2">融入生活，静谧守护</span>
          </div>
        </div>
