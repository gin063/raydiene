    ...
    <div class="relative z-10 container mx-auto px-6 md:px-12 pt-32 md:pt-40 pb-16">
      ...
      <div class="mt-16 text-center animate-fade-in-up" style="animation-delay: 0.4s;">
        <NuxtLink to="/contact/info"
          class="inline-flex items-center gap-2 px-6 py-2.5 rounded-full tracking-widest font-bold duration-300 transition-all backdrop-blur-md border border-transparent bg-white text-black hover:bg-white/10 hover:text-white hover:border-white/50">
          <span>联系客服</span>
