...
export default defineNuxtConfig({
  ...
  sitemap: {
    ...
    urls: [
      ...
      { loc: "/media/news/raydiene-panshi-max-launch-2026", priority: 0.7, changefreq: "monthly" },
      { loc: "/media/news/raydiene-tuv-certification", priority: 0.7, changefreq: "monthly" },
